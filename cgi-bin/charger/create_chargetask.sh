...
send_chargetask () {
    ...
    then
        ...
        if [ $? -eq 0 ];then
           echo '<pre>'
           sudo /opt/butler_server/erts-9.3.3.6/bin/escript /home/gor/rpc_call.escript chargetaskrec create_charging_task "[$1,$2,$3]." 
           echo '</pre>'
           echo "<br>"
           echo "OK Done...."
        else
...
echo "<br>"
echo "<br>"
echo "Enter Butler id, Charger_id and Ampere"
echo "<br>"
  echo "<form method=GET action=\"${SCRIPT}\">"\
       '<table nowrap>'\
		  ...
		  '<tr><td>Ampere</TD><TD><input type="number" name="Ampere" size=12></td></tr>'\
           '</tr></table>'
